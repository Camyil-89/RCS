# RCS
Инофационный стандарт сертификации доступный только на территории Российской Федерации. Российский стандарт сертификатов позволяет добавлять любую информацию в сертификат.
